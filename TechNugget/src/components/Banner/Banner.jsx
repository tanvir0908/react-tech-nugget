    ...
    <div className="md:flex py-20 px-20 justify-center items-center gap-5 mx-0 md:mx-20 bg-gray-200 rounded-xl">
      <div className="flex-1 mx-auto text-gray-600">
        <h2 className="text-4xl font-semibold leading-relaxed">
          ...
          you can have a{" "}
          <span className="font-bold text-black">Problem Free Life</span>.
        </h2>
      </div>
      <div className="flex-1 ">
        ...
        >
          ...
          <circle cx="256.45989" cy="513.095" r="59.24334" fill="#212529" />
          <rect
            x="304.17137"
            y="447.54324"
            width="732.99951"
          ...
          <rect
            ...
            fill="#212529"
          />
          <circle cx="363.56522" cy="33.66667" r="6.43478" fill="#212529" />
          <polygon
